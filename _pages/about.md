...
<div class="publication-container">
  ...
  <div>
    <span style="color: #96054d; font-weight: bold; font-size:0.8em">[IEEE TNNLS 2023]</span> Block-Wise Partner Learning for Model Compression. <br>
...
<div class="publication-container">
  ...
  <div>
    <span style="color: #96054d; font-weight: bold; font-size:0.8em">[IEEE TIP 2023]</span> Reaf: Remembering enhancement and entropy-based asymptotic forgetting for filter pruning.<br>
...
<div class="publication-container">
  ...
  <div>
    <span style="color: #96054d; font-weight: bold; font-size:0.8em">[IEEE TGRS 2023]</span> A Model-Driven Deep Mixture Network for Robust Hyperspectral Anomaly Detection. <br>
...
<div class="publication-container">
  ...
  <div>
    <span style="color: #96054d; font-weight: bold; font-size:0.8em">[IEEE TGRS 2022]</span> Rank-aware generative adversarial network for hyperspectral band selection. <br>
...
<div class="publication-container">
  ...
  <div>
    <span style="color: #96054d; font-weight: bold; font-size:0.8em">[IEEE TGRS 2023]</span> Co-compression via superior gene for remote sensing scene classification.<br>
...
<div class="publication-container">
  ...
  <div>
    <span style="color: #96054d; font-weight: bold; font-size:0.8em">[IEEE TGRS 2022]</span> Algorithm/hardware codesign for real-time on-satellite CNN-based ship detection in SAR imagery. <br>
...
<div class="publication-container">
  ...
  <div>
    <span style="color: #96054d; font-weight: bold; font-size:0.8em">[IEEE TC 2021]</span> Filter pruning via learned representation median in the frequency domain. <br>
...
<div class="publication-container">
  ...
  <div>
    <span style="color: #96054d; font-weight: bold; font-size:0.8em">[IEEE TC 2021]</span> Weakly supervised low-rank representation for hyperspectral anomaly detection. <br>
...
<div class="publication-container">
  ...
  <div>
    <span style="color: #96054d; font-weight: bold; font-size:0.8em">[IEEE Jstar 2020]</span> Background learning based on target suppression constraint for hyperspectral target detection. <br>
